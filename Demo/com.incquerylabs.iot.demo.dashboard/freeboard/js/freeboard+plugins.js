...
(function () {
	...
	freeboard.addStyle('.indicator-light', "border-radius:50%;width:50px;height:22px;border:2px solid #3d3d3d;margin-top:5px;float:left;background-color:#222;margin-right:10px;");
